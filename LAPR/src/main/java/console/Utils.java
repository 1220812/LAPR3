...
public class Utils {
     ...
     */
    static public double readDoubleFromConsole(String prompt) throws NumberFormatException {
        do {
            try {
                String input = readLineFromConsole(prompt);
     ...
     * @return the int
     */
    static public int showAndSelectMainMenuIndex(List list, String header){
        showMainMenuList(list, header);
        return selectsIndex(list);
    }
     ...
     * @param header the header
     */
    static public void showMainMenuList(List list, String header){
        System.out.println(header);
