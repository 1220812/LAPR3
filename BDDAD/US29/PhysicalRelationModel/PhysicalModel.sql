...
CREATE TABLE AirSensor (airSensorID number(10) GENERATED AS IDENTITY, windSpeed float(10), windIntensity float(10), temperature float(10), humidity float(10), atmosphericPressure float(10), PRIMARY KEY (airSensorID));
...
CREATE TABLE Component_Datasheet (componentID number(10) NOT NULL, compositionID number(20) NOT NULL, quantity number(10), PRIMARY KEY (componentID, compositionID));
CREATE TABLE Crop (cropID number(20) NOT NULL, startDate date, endDate date, area float(10), parcelID number(20) NOT NULL, plantID number(10) NOT NULL, PRIMARY KEY (cropID));
...
CREATE TABLE Fertigation (operationID number(10) NOT NULL, techniquesID number(10), revenueID number(10) NOT NULL, cropID number(20) NOT NULL, setorID number(10) NOT NULL, PRIMARY KEY (operationID));
CREATE TABLE Fertilization (operationID number(10) NOT NULL, "Mode" varchar2(20), productionFactorID number(20) NOT NULL, cropID number(20) NOT NULL, PRIMARY KEY (operationID));
...
CREATE TABLE GroundSensor (groundSensorID number(10) GENERATED AS IDENTITY, humidity float(10), temperature float(10), pH float(10), salinity float(10), parcelID number(20) NOT NULL, PRIMARY KEY (groundSensorID));
CREATE TABLE Harvest (operationID number(10) NOT NULL, quantity float(10), productId number(10) NOT NULL, cropID number(20) NOT NULL, PRIMARY KEY (operationID));
...
CREATE TABLE Operation (operationID number(10) NOT NULL, "date" date, PRIMARY KEY (operationID));
CREATE TABLE Plant (plantID number(10) GENERATED AS IDENTITY, speciesID number(10) NOT NULL, plantTypeID number(20) NOT NULL, PRIMARY KEY (plantID));
...
CREATE TABLE Product (productId number(10) GENERATED AS IDENTITY, designation varchar2(40), plantID number(10) NOT NULL, PRIMARY KEY (productId));
...
CREATE TABLE RainfallSensor (rainfallSensorID number(10) GENERATED AS IDENTITY, rainfall float(10), PRIMARY KEY (rainfallSensorID));
CREATE TABLE Revenue (revenueID number(10) GENERATED AS IDENTITY, PRIMARY KEY (revenueID));
CREATE TABLE Revenue_ProductionFactor (revenueID number(10) NOT NULL, productionFactorID number(20) NOT NULL, PRIMARY KEY (revenueID, productionFactorID));
...
CREATE TABLE Techniques (techniquesID number(10) GENERATED AS IDENTITY, name varchar2(40), PRIMARY KEY (techniquesID));
...
CREATE TABLE Watering (operationID number(10) NOT NULL, duration number(10), inicialHour varchar2(10), setorID number(10) NOT NULL, cropID number(20) NOT NULL, PRIMARY KEY (operationID));
...
CREATE TABLE WeatherStation (id number(10) GENERATED AS IDENTITY, airSensorID number(10) NOT NULL, groundSensorID number(10) NOT NULL, rainfallSensorID number(10) NOT NULL, PRIMARY KEY (id));
...
ALTER TABLE Fertilization ADD CONSTRAINT FKFertilizat738945 FOREIGN KEY (operationID) REFERENCES Operation (operationID);
ALTER TABLE Fertilization ADD CONSTRAINT FKFertilizat232544 FOREIGN KEY (cropID) REFERENCES Crop (cropID);
...
ALTER TABLE Fertilization ADD CONSTRAINT FKFertilizat332357 FOREIGN KEY (productionFactorID) REFERENCES ProductionFactor (productionFactorID);
