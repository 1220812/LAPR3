...
CREATE TABLE Fertigation (operationID number(10) NOT NULL, revenueID number(10) NOT NULL, setorID number(10) NOT NULL, duration number(10), inicialHour varchar2(10), PRIMARY KEY (operationID));
...
CREATE TABLE Log (logID number(10) NOT NULL, instant timestamp(0), operationDate date, operationType varchar2(40), PRIMARY KEY (logID));
